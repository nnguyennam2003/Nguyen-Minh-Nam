...
export default function SelectBox2({ currencies, selectedCurrency, onCurrencyChange }) {
    ...
    return (
        <div className="relative flex-1  rounded-xl">
            ...
            {dropdownOpen && (
                <ul className="absolute w-[300px] top-12 bg-[#36324A] h-[300px] overflow-auto rounded-md mt-1 z-10">
